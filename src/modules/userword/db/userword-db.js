...
exports.setLearnedStatus = (user_id, word_id) => UserWord.query().update({status_id: statusTypes.LEARNED.status_id, dateOfLearned: moment.format('DD/MM/YYYY')}).where('user_id', user_id).andWhere('word_id', word_id);